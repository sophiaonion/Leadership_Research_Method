...
add_data2($id, $answer,$number, "set4");
$_SESSION['id']=$id;
?>

<form action="set6.php" method="post" id="add_name_form">
  <p><label>how much do you agree with the following statements? 
      </label> <br><br>
        <?php
	$i=read("set5Q.txt",$drop_down_list);
	?>
